...
- Course: [Consulting Fundamentals](https://www.coursera.org/learn/consulting-fundamentals) on Coursera
...
### **Foundation Knowledge in Drones**
...
Vision of a hawk. A repository for arial/top-view image processing algorithms-models such as from drones, UAVs etc.

## Why the Shift?
The field of Natural Language Processing (NLP) has undergone significant advancements with the rise of large language models (LLMs). While LLMs have transformed NLP, there is an exciting opportunity to pivot towards image processing, particularly in areas where LLMs have not fully dominated, such as image analysis.

## Plan
1. Build Something Useful: Focus on developing applications that can benefit sectors like agriculture, medicine, defense, and consultancy.
2. Monetization Strategy: Implement a pay-per-use API model to generate passive income.
3. Future Scope: Start with 2D image processing, gradually progressing to 3D models, lidar, and photogrammetry.

## Action Items
1. Education and Training:
   - Enroll in image processing and object detection courses on Udemy.
   - Follow relevant YouTube playlists.
   - Study agriculture drone image processing tutorials.
   - Participate in Kaggle competitions.
   - Learn PyTorch for image processing and Ludwig for image fine-tuning.
2. Content Creation:
   - Prepare short demos and tutorials.
   - Publish articles on Medium.
   - Share insights and updates on LinkedIn.
3. Networking:
   - Connect with startups in Pune such as FlytBase, Lalit Startup, SoftTech, Saltmine, and BoM Startups.
   - Engage in the R&D agriculture project at COEP in collaboration with Erasmus.

## Projects
- Develop floor plan detection models.
- Explore midcurve neural networks.
- Work on COEP Erasmus agriculture projects.
- Develop OCR solutions for Sanskrit manuscripts using Sharada script.

This strategic move aims to leverage emerging opportunities in image processing while building a solid foundation for future innovations in 2D-3D Image/Geometric Modeling


## Companies to look for
- DroneAcharya / Drona Aviation(Pune, [website](https://droneacharya.com/))
- FlytBase (Pune, earlier NavStik Labs, [website](https://www.linkedin.com/company/flytbase/))
- Ayaan Autonomous Systems (Pune, [website](http://www.ayaan.ai/))
- Aeronica Advance Technologies (Pune, [website](https://aeronica.in/))
- Farm(x) (Lalit, Pune, [website](https://www.farmx.ag/))
- Quidich Innovation Labs (Mumbai, [website](https://www.quidich.com/))
- AIRPIX (Mumbai, [website](https://airpix.in/))
- Indrones (Mumbai, [website](https://indrones.com/))
- Skydeck / Asteria Aerospace (Bengaluru, [website](https://asteria.co.in/))
 -->